...
INSERT INTO `bundle_options` VALUES (1,1,1),(2,2,2),(3,3,3),(4,4,4),(5,5,5),(6,6,6);
...
INSERT INTO `bundles` VALUES (1,1,'Small Pack (250g)',12.99,1,5,49),(2,1,'Medium Pack (500g)',22.99,1,3,28),(3,1,'Large Pack (1kg)',39.99,1,2,13),(4,2,'Dark Chocolate (70% cocoa)',5.99,1,10,99),(5,2,'Milk Chocolate (40% cocoa)',5.99,1,10,77),(6,2,'White Chocolate',5.99,1,10,60);
...
INSERT INTO `items` VALUES (1,'Organic Coffee Beans','https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=400','Premium arabica coffee beans from sustainable farms',5.00),(2,'Artisan Chocolate Bar','https://images.unsplash.com/photo-1549007994-cb92caebd54b?w=400','Handcrafted chocolate with premium cocoa',3.00);
...
INSERT INTO `options` VALUES (1,1,'Small',1,'Small Pack (250g)'),(2,1,'Medium',2,'Medium Pack (500g)'),(3,1,'Large',3,'Large Pack (1kg)'),(4,2,'Dark',1,'Dark Chocolate (70% cocoa)'),(5,2,'Milk',2,'Milk Chocolate (40% cocoa)'),(6,2,'White',3,'White Chocolate');
